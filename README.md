...
[![Tests](https://img.shields.io/badge/tests-590%2F590-brightgreen)](https://github.com/zedarvates/botte-secrete)
...
```bash
python scripts/run_tests.py   # 590 tests, 0 cloud calls
```
...
cd botte-secrete
python scripts/run_tests.py                    # 590 tests — everything works
