...
SUITES = [
    ...
    ("adaptive_runtime", [sys.executable, "-m", "skills.llm_backends.test_runtime"], "skills/llm_backends/"),
    ("runtime_acceptance", [sys.executable, "-m", "skills.llm_backends.test_acceptance"], "skills/llm_backends/"),
