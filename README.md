...
[![Tests](https://img.shields.io/badge/tests-309%2F309-brightgreen)](https://github.com/zedarvates/botte-secrete)
...
| `docs_steward/` | **P36** — Scoped docs map for multi-component projects — bounded coders load only their scope + linked globals | Cut always-on doc tokens |
...
- [x] P36: Docs steward — scoped documentation map for multi-component projects (bounded coders load only their scope + linked globals), `docs_map` MCP tool
