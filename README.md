...
[![Tests](https://img.shields.io/badge/tests-575%2F575-brightgreen)](https://github.com/zedarvates/botte-secrete)
...
```bash
python scripts/run_tests.py   # 575 tests, 0 cloud calls
```
...
cd botte-secrete
python scripts/run_tests.py                    # 575 tests — everything works
