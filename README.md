...
[![Tests](https://img.shields.io/badge/tests-582%2F582-brightgreen)](https://github.com/zedarvates/botte-secrete)
...
```bash
python scripts/run_tests.py   # 582 tests, 0 cloud calls
```
...
cd botte-secrete
python scripts/run_tests.py                    # 582 tests — everything works
