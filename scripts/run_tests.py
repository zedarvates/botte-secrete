...
SUITES = [
    ...
    ("verified_runs", [sys.executable, "-m", "skills.conductor.test_verified"], "skills/conductor/"),
    ("verified_pilots", [sys.executable, "-m", "skills.conductor.test_verified_pilots"], "skills/conductor/"),
