...
[![Tests](https://img.shields.io/badge/tests-568%2F568-brightgreen)](https://github.com/zedarvates/botte-secrete)
...
```bash
python scripts/run_tests.py   # 568 tests, 0 cloud calls
```
...
cd botte-secrete
python scripts/run_tests.py                    # 568 tests — everything works
