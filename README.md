...
[![Tests](https://img.shields.io/badge/tests-574%2F574-brightgreen)](https://github.com/zedarvates/botte-secrete)
...
```bash
python scripts/run_tests.py   # 574 tests, 0 cloud calls
```
...
cd botte-secrete
python scripts/run_tests.py                    # 574 tests — everything works
